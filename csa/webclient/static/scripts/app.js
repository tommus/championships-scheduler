...
angular.module('csa', ['ngRoute', 'ngCookies', 'ngStorage', 'angular-toasty', 'ui.bootstrap', 'settings'])
  ...
  .config(function ($routeProvider, $httpProvider, settings) {
    $routeProvider
      ...
      .when('/championships/details/:id', {
        templateUrl: 'static/partials/championships/details.html',
        controller:  'ChampionshipsDetailsCtrl'
      })
